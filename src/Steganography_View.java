...
public class Steganography_View extends JFrame
{
	 ...
	 */
	public JPlaceholderTextField	getText()		{ return input;				}
	/*
	...
	private class Text_Panel extends JPanel
	{
		...
		public Text_Panel()
		{
			...
			input = new JPlaceholderTextField("Enter Text To Encode");
			input.setFont(input.getFont().deriveFont(30f));
			input.setColumns(20);
	        input.setPlaceholder("Enter your Text to Encode");
	        final Font f = input.getFont();
	        input.setFont(new Font(f.getName(), f.getStyle(), 30));
	...
	private class Image_Panel extends JPanel
	{
		...
		public Image_Panel()
		{
			...
			image_input.setText("Choose a file to decode");
			layoutConstraints.gridx 	= 0; layoutConstraints.gridy = 0; 
			layoutConstraints.gridwidth = 1; layoutConstraints.gridheight = 1; 
			layoutConstraints.fill 		= GridBagConstraints.BOTH; 
			layoutConstraints.insets 	= new Insets(0,0,0,0); 
